...
public class AddAttendanceSessionActivity extends AppCompatActivity {
    ...
    private final String[] branchString = new String[]{"LSI", "LISI", "LGM", "LGEnerg", "LGC","LEM","LEEA","Prepa","ING"};
    private final String[] SemString = new String[]{"1st", "2nd", "3rd", "4th", "5th"};
    private final String[] subjectFinal = new String[]{"Dev Mobile", "ML", "AI", "SOA", "Big data", "Cloud computing","ERP","English","Entrepreneurship","Prep Env Prof"};
